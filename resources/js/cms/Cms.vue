            ...
            <transition name="slide-fade-to-right">
                ...
                <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
                    ...
                    <div class="flex-shrink-0 flex items-center px-4">
                        <img class="h-8 w-auto" src="/img/system/company-logo.png" alt="Company logo">
                    </div>
                    <div class="mt-5 flex-1 h-0 overflow-y-auto">
                        <nav class="px-2 space-y-1">
                            ...
                            <router-link @click.native="toggleMobileNav" :to="{ name: 'Team' }" class="text-gray-600 hover:bg-gray-200 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-400 group-hover:text-gray-500 mr-3 flex-shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
                ...
                <div class="flex flex-col flex-grow border-r border-gray-200 pt-5 bg-white overflow-y-auto">
                    <div class="flex items-center flex-shrink-0 px-4">
                        <img class="h-8 w-auto" src="/img/system/company-logo.png" alt="Workflow">
                    </div>
