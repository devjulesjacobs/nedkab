            ...
            <transition name="slide-fade-to-right">
                ...
                <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
                    ...
                    <div class="flex-shrink-0 flex items-center px-4">
                        <img class="h-8 w-auto" src="/img/system/company-logo.jpg" alt="Company logo">
                    </div>
                    <div class="mt-5 flex-1 h-0 overflow-y-auto">
                        <nav class="px-2 space-y-1">
                            <router-link @click.native="toggleMobileNav" :to="{ name: 'Dashboard' }" class="text-gray-600 hover:bg-gray-200 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                            ...
                            <router-link @click.native="toggleMobileNav" :to="{ name: 'Posts' }" class="text-gray-600 hover:bg-gray-200 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                            ...
                            <a @click="signOut" class="text-red-600 hover:bg-red-200 hover:text-red-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" class="text-red-400 group-hover:text-red-500 mr-3 flex-shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
                ...
                <div class="flex flex-col flex-grow border-r border-gray-200 pt-5 bg-white overflow-y-auto">
                    <div class="flex items-center flex-shrink-0 px-4">
                        <img class="h-8 w-auto" src="/img/system/company-logo.jpg" alt="Workflow">
                    </div>
                    <div class="mt-5 flex-grow flex flex-col">
                        <nav class="flex-1 px-2 pb-4 space-y-1">
                            ...
                            <a @click="signOut" class="text-red-600 hover:bg-red-200 cursor-pointer hover:text-red-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" class="text-red-500 group-hover:text-red-500 mr-3 flex-shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                                </svg>
                                Logout
                            </a>
                    ...
                    <div class="flex-1 px-4 flex justify-between">
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div class="ml-3 relative">
                                <div>
                                    <button @click="toggleMiniMenu" type="button" class="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        <span class="sr-only">Open user menu</span>
                                        <img class="h-8 w-8 rounded-full object-cover object-center" src="/img/system/company-icon.png" alt="">
                                    </button>
                                </div>
